...
if st.session_state.page == 'welcome':
    ...
    # تنسيق محتوى الرسالة بالكامل في المنتصف
    st.markdown("""
    <div style='text-align: center; direction: rtl;'>
        <h3>👋 أهلاً بك يا دكتور في نظامنا الجديد،</h3>
        <p>يسعدنا ويشرفنا تقديم هذا العمل المتكامل المخصص لفحص وتشخيص أوراق نبات <b>الريحان</b> بدقة هندسية ونظام ذكاء اصطناعي محمي ومستقر 100%.</p>
        <br>
        <h4>🔬 ماذا يقدم لك النظام؟</h4>
        <p>• كشف فوري عن سلامة الأوراق (Healthy).</p>
        <p>• رصد دقيق لمرض البياض الزغبي (Downy Mildew).</p>
        <p>• رصد دقيق لمرض تبقع الأوراق (Leaf Spot).</p>
        <p>• تقديم تقرير علاجي زراعي فوري (كيميائي وفطري).</p>
        <br>
        <hr>
        <p><i>💡 تم تطوير هذا النظام بكل فخر بواسطة أحمد حسني والتيم الخاص به، تحت إشرافكم الكريم.</i></p>
    </div>
    """, unsafe_allow_html=True)
